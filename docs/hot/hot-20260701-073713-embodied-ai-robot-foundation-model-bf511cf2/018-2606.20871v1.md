...
tldr: "google deepmind 相关近期论文；来源 arXiv fallback。We study how trajectory-shape diversity in demonstrations affects imitation learning (IL) performance across models, tasks, and data scales."
motivation: "筛选最近 30 天内由google deepmind相关文本命中的具身智能论文。"
method: "We study how trajectory-shape diversity in demonstrations affects imitation learning (IL) performance across models, ta…"
...
google deepmind 相关近期论文；来源 arXiv fallback。We study how trajectory-shape diversity in demonstrations affects imitation learning (IL) performance across models, tasks, and data scales.
